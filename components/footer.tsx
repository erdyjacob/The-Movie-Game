      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex flex-col items-center space-y-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-sm text-slate-400">
            {/* Report a bug */}
            <Link href="mailto:support@moviesgame.com" className="hover:text-white transition-colors duration-200">
              Report a bug
            </Link>
          ...
          {/* Copyright */}
          <div className="text-xs text-slate-500 text-center">© 2025 The Movie Game. All rights reserved.</div>
        </div>
      </div>
    </footer>
  )

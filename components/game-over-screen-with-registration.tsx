...
export default function GameOverScreen({
  ...
  useEffect(() => {
    ...
    // Check if user has played before and needs to register
    ...
    localStorage.setItem("movieGameHasPlayed", "true")

    // Update leaderboard if user is registered
    updateLeaderboard()
  }, [history.length])
  ...
  const updateLeaderboard = async () => {
    ...
    try {
      // Get collection stats from localStorage
      // These should match how you're currently storing collection data
